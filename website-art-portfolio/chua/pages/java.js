...
//ILLUS GALLERY
let galleryImages = document.querySelectorAll('.illus-image, .spreads__image, .infog__image, .packaging-image');
...
galleryImages.forEach(function(image, index){
    image.onclick = function(){
        ...
        newImg.classList.remove('illus-image');
...
function changeImg(change){
    ...
    newImg.setAttribute('src', '../images/galleryImg-' + calcNewImg + '.png');
